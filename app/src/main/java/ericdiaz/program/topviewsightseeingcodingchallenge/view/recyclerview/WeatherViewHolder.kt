...
class WeatherViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun onBind(weekdayWeather: WeekdayWeather) {
        ...
        itemView.weekday_temperature_low_text_view.text = weekdayWeather.lowTemperature.getLowTempFormat()

        itemView.weekday_temperature_high_text_view.text = weekdayWeather.highTemperature.getHighTempFormat()
    }
}